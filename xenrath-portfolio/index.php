<?php 
  ...
  $result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCU_scVgSTMPeKIXrl6F9vAw&key=AIzaSyBHo6RizoMn_ZZCkTtm6Xy9tJ_nLtdNVEE');
  ...
  // latest video
  $urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyBHo6RizoMn_ZZCkTtm6Xy9tJ_nLtdNVEE&channelId=UCU_scVgSTMPeKIXrl6F9vAw&maxResults=1&order=date&part=snippet';
            ...
            <div class="col-md-5">
              <div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="g-ytsubscribe" data-channelid="UCU_scVgSTMPeKIXrl6F9vAw" data-layout="default" data-count="default"></div>
                </div>
              </div>
